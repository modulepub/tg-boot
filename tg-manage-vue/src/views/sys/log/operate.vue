<template>
	<el-card class="layout-query">
		<el-form ref="queryRef" :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			...
			<el-form-item prop="status">
				<tg-dict-select v-model="state.queryForm.status" placeholder="操作状态" dict-type="success_fail" clearable> </tg-dict-select>
			</el-form-item>
			<el-form-item>
	...
	<el-card>
		...
		>
			...
			<tg-dict-column prop="operateType" label="操作类型" dict-type="log_operate_type" header-align="center" align="center"></tg-dict-column>
			...
			<tg-dict-column prop="status" label="操作状态" dict-type="success_fail"></tg-dict-column>
