				...
				<el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table" @selection-change="selectionChangeHandle">
					...
					<el-table-column label="操作" fixed="right" header-align="center" align="center" width="280">
						<template #default="scope">
							...
							<el-button v-if="scope.row.cusDealtCompleteStatusCode == '0'" type="primary" link @click="completeHandle(scope.row.promotionTaskCode)"
								>完单</el-button
							>
						</template>
					</el-table-column>
...
const resetR= (queryRef: any) => {
  ...
  state.queryForm = {}
  state.queryForm.promotionTaskTypeCode = 'service'
