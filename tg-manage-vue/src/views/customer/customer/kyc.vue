			...
			<el-tab-pane label="营销记录">
				<el-card>
					<el-table v-loading="promotionRelationLoading" :data="promotionRelationList" border>
						...
						<el-table-column prop="userRealName" label="员工姓名" header-align="center" align="center" show-overflow-tooltip></el-table-column>
						<tg-dict-column prop="promotionTaskCode" label="营销任务" dict-code="promotionTaskCode"></tg-dict-column>
...
const loadPromotionRelationList = () => {
	if (customerInfo.value && customerInfo.value.cusCode) {
		...
		service
			.get('/mgt/customer/customerPromotionRelation/list', {
				params: {
