<template>
	<el-card class="layout-query">
		<el-form ref="queryRef" :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			...
			<el-form-item prop="cusIdCardNum">
				<el-input v-model="state.queryForm.cusIdCardNum" placeholder="客户身份证号"></el-input>
			</el-form-item>
	...
	<el-card>
		<el-tabs v-model="activeTab" @tab-click="handleTabClick">
			<el-tab-pane v-for="item in promotionTaskList" :key="item.dictItemValue" :label="item.dictItemText" :name="item.dictItemValue"></el-tab-pane>
		</el-tabs>
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table" @selection-change="selectionChangeHandle">
			<el-table-column prop="promotionRelCode" label="编码" header-align="center" align="center" show-overflow-tooltip></el-table-column>
			...
			<el-table-column prop="cusIdCardNum" label="客户身份证号" header-align="center" align="center" show-overflow-tooltip></el-table-column>
			<el-table-column prop="cusPhone" label="客户手机号" header-align="center" align="center" show-overflow-tooltip></el-table-column>
			<template v-if="state.queryForm.promotionTaskCode == 'contactCustomer'">
			...
			<template v-if="state.queryForm.promotionTaskCode == 'serveCustomers'">
...
<script setup lang="ts" name="CustomertelemarketerRelationIndex">
...
const promotionTaskList = getDictDataList(appStore.dictList, 'promotionTaskCode')
const activeTab = ref(promotionTaskList.length > 0 ? promotionTaskList[0].dictItemValue : '0')

const state: IHooksOptions = reactive({
	dataListUrl: '/mgt/customer/customerPromotionRelation/list',
	...
	queryForm: {
		...
		userCode: '',
		userRealName: '',
		promotionTaskCode: promotionTaskList.length > 0 ? promotionTaskList[0].dictItemValue : '',
		cusName: '',
		cusIdCardNum: '',
		cusPhone: '',
...
const handleTabClick = (tab: any) => {
	state.queryForm.promotionTaskCode = tab.props.name
	getDataList()
}
