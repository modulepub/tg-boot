...
export function getEnvBaseUrl() {
  ...
  const VITE_SERVER_BASEURL__WEIXIN_DEVELOP = import.meta.env.VITE_SERVER_BASEURL
  const VITE_SERVER_BASEURL__WEIXIN_TRIAL = import.meta.env.VITE_SERVER_BASEURL
  const VITE_SERVER_BASEURL__WEIXIN_RELEASE = import.meta.env.VITE_SERVER_BASEURL
