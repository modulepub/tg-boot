...
import pub.module.common.config.web.convert.StringToProjectEnumConverter;
...
public class WebMvcConfiguration implements WebMvcConfigurer {
    ...
    public void addFormatters(FormatterRegistry registry) {
        registry.addConverter(new StringToProjectEnumConverter());
    }

    /**
     * 静态资源的配置使得可以从磁盘中读取 Html、图片、视频、音频等
     */
    @Override
