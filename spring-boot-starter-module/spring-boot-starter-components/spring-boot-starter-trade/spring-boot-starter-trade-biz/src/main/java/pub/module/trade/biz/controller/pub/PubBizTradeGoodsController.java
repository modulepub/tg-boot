...
public class PubBizTradeGoodsController {
	...
	public Result<IPage<TdGoods>> queryPageList(TdGoods tdGoods,
		...
		queryWrapper.eq("td_gd_enabled_code", "1");
		queryWrapper.orderByAsc("seq_no").orderByAsc("td_gd_price");
    ...
    public Result<TdGoods> queryByCode(@RequestParam("tdGdCode") String tdGdCode) {
        ...
        queryWrapper.lambda()
                .eq(TdGoods::getTdGdCode, tdGdCode)
                .eq(TdGoods::getTdGdEnabledCode, "1");
