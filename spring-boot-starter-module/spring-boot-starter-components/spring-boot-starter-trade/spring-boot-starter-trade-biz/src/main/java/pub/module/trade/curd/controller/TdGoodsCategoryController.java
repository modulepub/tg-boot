 ...
 * @version V1.0
 */
@Tag(name="td_goods_category")
@RestController
@RequestMapping("/trade/curd/tdGoodsCategory")
@Slf4j
public class TdGoodsCategoryController{
	@Resource
	private ITdGoodsCategoryService tdGoodsCategoryService;
	
	@Operation(summary="td_goods_category-分页列表查询")
	...
	@Operation(summary="td_goods_category-添加")
	...
	@Operation(summary="td_goods_category-编辑")
	...
	@Operation(summary="td_goods_category-通过id删除")
	@DeleteMapping(value = "/delete")
	public Result<String> delete(@RequestParam(name="id") String id) {
		tdGoodsCategoryService.removeById(id);
		return Result.ok("删除成功!");
	}
	
	@Operation(summary="td_goods_category-批量删除")
	@DeleteMapping(value = "/deleteBatch")
	public Result<String> deleteBatch(@RequestParam(name="ids") String ids) {
		this.tdGoodsCategoryService.removeByIds(Arrays.asList(ids.split(",")));
		return Result.ok("批量删除成功!");
	}
	
	@Operation(summary="td_goods_category-通过id查询")
