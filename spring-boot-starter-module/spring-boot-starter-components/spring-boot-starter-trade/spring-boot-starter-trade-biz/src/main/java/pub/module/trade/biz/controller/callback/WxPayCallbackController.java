package pub.module.trade.biz.controller.callback;
...
public class WxPayCallbackController {
    ...
    public String parseOrderNotifyResult(@RequestBody String jsonData, HttpServletRequest request) {
        try {
            ...
            TdOrder tdOrder = bizTradeOrderService.paidOrder(wxPayService.parseOrderNotifyV3Result(jsonData, signatureHeader).getResult().getOutTradeNo());
            return WxPayNotifyResponse.success(tdOrder.getTdOdCode());
