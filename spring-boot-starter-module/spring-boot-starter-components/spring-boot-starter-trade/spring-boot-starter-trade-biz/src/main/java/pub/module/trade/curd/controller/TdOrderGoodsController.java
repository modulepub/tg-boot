 ...
 * @version V1.0
 */
@Tag(name="td_order_goods")
@RestController
@RequestMapping("/trade/curd/tdOrderGoods")
@Slf4j
public class TdOrderGoodsController{
	@Resource
	private ITdOrderGoodsService tdOrderGoodsService;
	
	@Operation(summary="td_order_goods-分页列表查询")
	...
	@Operation(summary="td_order_goods-添加")
	...
	@Operation(summary="td_order_goods-编辑")
	...
	@Operation(summary="td_order_goods-通过id删除")
	...
	@Operation(summary="td_order_goods-批量删除")
	...
	@Operation(summary="td_order_goods-通过id查询")
