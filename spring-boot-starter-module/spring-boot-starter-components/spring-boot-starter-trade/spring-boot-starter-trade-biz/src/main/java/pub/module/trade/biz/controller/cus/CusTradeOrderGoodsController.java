...
@Tag(name ="用户端-订单商品")
@RestController
@RequestMapping("/cus/trade/tradeOrderGoods")
@Slf4j
public class CusTradeOrderGoodsController {
	@Resource
	private ITdOrderGoodsService tradeOrderGoodsService;
	
	@Operation(summary = "用户端-订单商品-分页列表查询订单商品-分页列表查询")
    ...
    @Operation(summary = "用户端-订单商品-分页查询订单商品列表")
	...
	@Operation(summary = "用户端-订单商品-添加订单商品-添加")
	...
	@Operation(summary = "用户端-订单商品-编辑订单商品-编辑")
	...
	@Operation(summary = "用户端-订单商品-通过id删除订单商品-通过id删除")
	...
	@Operation(summary = "用户端-订单商品-批量删除订单商品-批量删除")
	...
	@Operation(summary = "用户端-订单商品-通过id查询订单商品-通过id查询")
