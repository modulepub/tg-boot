...
import pub.module.trade.crud.mapper.TdOrderMapper;
...
public class TdOrderServiceImpl extends ServiceImpl<TdOrderMapper, TdOrder> implements ITdOrderService {
    ...
    @Override
    public TdOrderStatisticsDTO getStatistics() {
        TdOrderStatisticsDTO statistics = this.getBaseMapper().selectStatistics();
        return statistics == null ? new TdOrderStatisticsDTO() : statistics;
    }
