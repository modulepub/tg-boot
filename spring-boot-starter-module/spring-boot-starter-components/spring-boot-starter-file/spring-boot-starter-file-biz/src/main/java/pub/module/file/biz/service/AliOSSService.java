...
public class AliOSSService {
    ...
    private PartETag uploadChunkPart(String uploadId, String key, InputStream inputStream,
        ...
        // 阿里云 oss 文件根目录
        partRequest.setBucketName(bizFileAutoConfiguration.getOssBucketName());
        // 文件key
    ...
    public Boolean checkExist(String key) {
        return ossClient.doesObjectExist(bizFileAutoConfiguration.getOssBucketName(), key);
    }
    ...
    private CompleteMultipartUploadResult uploadChunkComplete(String uploadId, String key, List<PartETag> chunkTags) {
        CompleteMultipartUploadRequest completeMultipartUploadRequest =
                new CompleteMultipartUploadRequest(bizFileAutoConfiguration.getOssBucketName(), key, uploadId, chunkTags);
    ...
    private String uploadChunkInit(String key) {
        // 创建分片上传对象
        InitiateMultipartUploadRequest uploadRequest = new InitiateMultipartUploadRequest(bizFileAutoConfiguration.getOssBucketName(), key);
        // 初始化分片
    ...
    public int uploadChunk(File file, String md5, Integer chunkIndex,
        ...
        chunkIndex++;
        initOss(bizFileAutoConfiguration.getOssEndPoint(), bizFileAutoConfiguration.getOssAccessKeyId(), bizFileAutoConfiguration.getOssAccessKeySecret());
        // 判断是否上传
    ...
    public String upload(InputStream inputStream, String fileName, String fileDir) throws Exception {
        ...
        String newBucket = bizFileAutoConfiguration.getOssBucketName();
        //判断桶是否存在,不存在则创建桶
        ...
        PutObjectResult result = ossClient.putObject(newBucket, filePath.toString(), inputStream);
