...
public class UploadServiceImpl implements BizUploadService {
    ...
    public JSONObject getConfig(){
        ...
        if(jsonObject==null){
            ...
            aliOss.set("endpoint","oss-cn-hangzhou.aliyuncs.com");
            aliOss.set("accessKey","YOUR_ALIYUN_ACCESS_KEY_ID");
            aliOss.set("secretKey","your-oss-secret-key-here");
            aliOss.set("bucketName","example-bucket");
