...
public class MgtDictController {
	...
	@Operation(summary="管理端-sys_dict-分页列表查询")
	...
	@Operation(summary="管理端-sys_dict-添加")
	...
	@Operation(summary="管理端-sys_dict-编辑")
	...
	@Operation(summary="管理端-sys_dict-通过id删除")
	...
	@Operation(summary="管理端-sys_dict-通过id查询")
