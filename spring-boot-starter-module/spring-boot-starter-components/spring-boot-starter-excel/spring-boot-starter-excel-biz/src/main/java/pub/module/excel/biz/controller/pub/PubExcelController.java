package pub.module.excel.biz.controller.pub;
...
@Tag(name = "公开-用户端-工具")
@RestController
@RequestMapping("/pub/excel")
public class PubExcelController {
    ...
    @Operation(summary = "公开-用户端-导出EXCEL", description = "公开-导出EXCEL")
    ...
    File getTemplateFile(String templatePath) {
        File result;
        String fileType = FileUtil.getSuffix(templatePath);
        Assert.notEmpty(templatePath, "templatePath is not null");
        if (templatePath.startsWith("http")) {
            result = FileUtil.createTempFile("."+fileType,false);
    ...
    @SneakyThrows
    @Operation(summary = "公开-用户端-导入EXCEL", description = "公开-导入EXCEL")
    ...
    @SneakyThrows
    @Operation(summary = "公开-用户端-导入状态", description = "公开-导入状态")
    ...
    @SneakyThrows
    @Operation(summary = "公开-用户端-下载导入EXCEL结果", description = "公开-下载导入EXCEL结果")
