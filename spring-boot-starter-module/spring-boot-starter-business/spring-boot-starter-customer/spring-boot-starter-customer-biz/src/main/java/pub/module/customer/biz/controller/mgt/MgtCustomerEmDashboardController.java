...
public class MgtCustomerEmDashboardController {
    ...
    public Result<IPage<SalesPerformanceResVO>> salesPerformanceList(SalesPerformanceReqVO salesPerformanceReqVO) {
        ...
        for (UserDTO userDTO : list) {
            ...
            long cusSalesTotal = customerPromotionRelationService.count(
                    new QueryWrapper<CustomerPromotionRelation>()
            ...
            long cusFollowUpTotal = customerPromotionRelationService.count(
                    new QueryWrapper<CustomerPromotionRelation>()
                            .eq("user_code", userDTO.getUserCode())
            ...
            long cusSalesDealtTotal = customerPromotionRelationService.count(
                    new QueryWrapper<CustomerPromotionRelation>()
                            .eq("user_code", userDTO.getUserCode())
