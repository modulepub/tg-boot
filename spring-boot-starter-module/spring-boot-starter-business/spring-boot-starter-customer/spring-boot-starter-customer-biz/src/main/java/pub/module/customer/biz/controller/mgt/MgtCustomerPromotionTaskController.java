...
public class MgtCustomerPromotionTaskController {
    ...
    @Operation(summary = "管理端-服务池管理分页列表查询")
    ...
    public static class AssignTelemarketerVO {
        @Schema(description = "管理端-客户编码")
        List<String> cusCodeList;
        @Schema(description = "管理端-员工编码")
        List<String> userCodeList;
        @Schema(description = "管理端-营销任务类型编码")
        private String promotionTaskTypeCode;
    }

    @Operation(summary = "管理端-客户分配")
    ...
    @Operation(summary = "管理端-客户营销关系添加")
    ...
    @Operation(summary = "管理端-客户营销关系编辑")
    ...
    @Operation(summary = "管理端-客户营销关系批量删除")
    ...
    @Operation(summary = "管理端-客户营销关系通过id查询")
