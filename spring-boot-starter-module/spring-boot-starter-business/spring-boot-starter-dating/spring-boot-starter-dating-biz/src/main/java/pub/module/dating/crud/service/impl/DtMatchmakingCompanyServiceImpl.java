...
import pub.module.dating.crud.mapper.DtMatchmakingCompanyMapper;
...
public class DtMatchmakingCompanyServiceImpl extends ServiceImpl<DtMatchmakingCompanyMapper, DtMatchmakingCompany> implements DtMatchmakingCompanyService {
    ...
    @Override
    public DtMatchmakingCompany getByAdminUserCode(String adminUserCode) {
        if (StrUtil.isBlank(adminUserCode)) {
            return null;
        }
        return this.getOne(new QueryWrapper<DtMatchmakingCompany>()
                .eq("mk_company_admin_user_code", adminUserCode.trim())
