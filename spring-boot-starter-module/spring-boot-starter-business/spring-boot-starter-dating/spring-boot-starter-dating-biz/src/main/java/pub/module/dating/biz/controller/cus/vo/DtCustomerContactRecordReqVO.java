package pub.module.dating.biz.controller.cus.vo;
...
import pub.module.dating.api.constants.ContactRecordMethodCodeEnum;
import pub.module.dating.api.constants.ContactRecordSourceCodeEnum;
import pub.module.dating.api.constants.CusIntentionLevelCodeEnum;
...
public class DtCustomerContactRecordReqVO {
    @Schema(description = "联络方式（1电话、2个人微信、3企业微信）")
    private ContactRecordMethodCodeEnum contactRecordMethodCode;
    @Schema(description = "联络记录来源（1手工创建、2电访系统、企业微信）")
    private ContactRecordSourceCodeEnum contactRecordSourceCode;
