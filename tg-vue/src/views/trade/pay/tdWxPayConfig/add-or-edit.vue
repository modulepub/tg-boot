...
const init = (wxPayConfigCode?: string) => {
	...
	if (wxPayConfigCode) {
		service.get('/mgt/trade/tdWxPayConfig/queryById?id=' + encodeURIComponent(wxPayConfigCode)).then(res => {
...
const submitHandle = () => {
	dataFormRef.value.validate((valid: boolean) => {
		...
		const http = isEdit.value ? service.post('/mgt/trade/tdWxPayConfig/edit', payload) : service.post('/mgt/trade/tdWxPayConfig/add', payload)
		http.then(() => {
			ElMessage.success({
