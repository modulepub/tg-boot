...
<script setup lang="ts" name="TradeTdWxPayConfigIndex">
...
const state: IHooksOptions = reactive({
	dataListUrl: '/mgt/trade/tdWxPayConfig/list',
	deleteUrl: '/mgt/trade/tdWxPayConfig/delete',
...
const refreshRuntimeHandle = () => {
	service.post('/mgt/trade/tdWxPayConfig/refreshRuntime').then(() => {
