	...
	<el-dialog v-model="visible" title="订单详情" width="900px" :close-on-click-modal="false">
		<el-descriptions :column="2" border>
			...
			<el-descriptions-item label="支付状态">
				<el-tag v-if="dataForm.tdOdPaidStatusCode === '1'" type="success">已支付</el-tag>
		...
		<el-table v-loading="goodsLoading" :data="goodsList" border>
			...
			<el-table-column prop="tdOdPaidCode" label="支付状态" width="120">
				<template #default="scope">
					<el-tag v-if="scope.row.tdOdPaidCode === '1'" type="success">已支付</el-tag>
					<el-tag v-else type="info">未支付</el-tag>
				</template>
			</el-table-column>
		</el-table>
