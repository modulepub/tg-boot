				...
				<el-card>
					...
					<el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table" @selection-change="selectionChangeHandle">
						...
						<el-table-column
							...
							width="100"
						></el-table-column>
						<el-table-column prop="nodeViewCount" label="阅读数" header-align="center" align="center" width="90"></el-table-column>
						...
						<el-table-column label="操作" fixed="right" header-align="center" align="center" width="220">
							<template #default="scope">
								...
								<el-button v-auth="'cmsCmsNodeList'" type="primary" link @click="openReadRecord(scope.row)">阅读记录</el-button>
					...
					<read-record-dialog ref="readRecordDialogRef"></read-record-dialog>
				</el-card>
			</div>
		</div>
	</div>
...
import ReadRecordDialog from './read-record-dialog.vue'
...
const openReadRecord = (row: any) => {
	readRecordDialogRef.value?.init(row)
}
