<template>
	<el-card style="margin-bottom: 10px">
		<el-form ref="queryRef" :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			...
			<el-form-item prop="cusAssignSalesTimeRangeArray">
				<el-date-picker
					v-model="state.queryForm.cusAssignSalesTimeRangeArray"
					type="daterange"
					range-separator="至"
					start-placeholder="起始分配日期"
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table" @selection-change="selectionChangeHandle">
			...
			<tg-dict-column prop="cusFollowUpStatusCode" label="跟进状态" width="100" dict-code="cusFollowUpStatusCode"></tg-dict-column>
			...
			<el-table-column prop="cusAssignSalesTime" label="分配日期" header-align="center" align="center" show-overflow-tooltip></el-table-column>
