<template>
	...
	<el-card>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table" @selection-change="selectionChangeHandle">
			...
			></el-table-column>
			<el-table-column prop="cusCode" label="客户编号" header-align="center" align="center" width="100" show-overflow-tooltip></el-table-column>
			...
			<el-table-column prop="userCode" label="员工账号" header-align="center" align="center" width="100" show-overflow-tooltip></el-table-column>
			<el-table-column prop="userRealName" label="员工姓名" header-align="center" align="center" width="100" show-overflow-tooltip></el-table-column>
			<tg-dict-column prop="contactRecordSourceCode" label="记录来源" dict-code="contactRecordSourceCode" width="100"></tg-dict-column>
			<tg-dict-column prop="contactRecordMethodCode" label="联络方式" dict-code="contactRecordMethodCode" width="100"></tg-dict-column>
			<el-table-column
				width="120"
			...
			<tg-dict-column prop="cusIntentionLevelCode" label="意向等级" width="100" dict-code="cusIntentionLevelCode"></tg-dict-column>
