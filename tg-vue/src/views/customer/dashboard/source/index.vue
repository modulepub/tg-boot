<template>
	...
	<el-card>
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border class="layout-table" @selection-change="selectionChangeHandle">
			<el-table-column prop="cusSourceCode" label="客户渠道来源" header-align="center" align="center" show-overflow-tooltip></el-table-column>
			<el-table-column prop="cusTotal" label="客户总数" header-align="center" align="center" show-overflow-tooltip></el-table-column>
			<el-table-column prop="customerContactTotal" label="联络总数" header-align="center" align="center" show-overflow-tooltip></el-table-column>
			<el-table-column prop="InvalidCustomerTotal" label="无效客户数" header-align="center" align="center" show-overflow-tooltip></el-table-column>
			<el-table-column prop="cusAnswerTotal" label="接听数" header-align="center" align="center" show-overflow-tooltip></el-table-column>
			<el-table-column prop="cusAnswerRate" label="接听率" header-align="center" align="center" show-overflow-tooltip></el-table-column>
			<el-table-column
			...
			></el-table-column>
			<el-table-column prop="cusIntentionRate" label="意向客户率" header-align="center" align="center" show-overflow-tooltip></el-table-column>
...
const state: IHooksOptions = reactive({
	dataListUrl: '/mgt/customer/dashboard/resourceList',
